...
/*for(let i = 0; i < chaussures.length; i++){
  console.log("La Chaussure de Marque : " + chaussures[i].marque + " et Modèle : " + chaussures[i].titre)
}*/

/*chaussures.forEach(function(chaussure){
  console.log("La Chaussure de Marque : " + chaussure.marque + " et Modèle : " + chaussure.titre)
})*/
...
chaussures.filter(function(chaussure){
  ...
  console.log("La Chaussure de Marque : " + chaussure.marque + " et modèle " + chaussure.titre + " est Collector")
})
